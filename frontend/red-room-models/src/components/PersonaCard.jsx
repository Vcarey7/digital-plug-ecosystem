  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {exclusiveGone && (
          <span className="absolute left-2 top-2 flex items-center gap-1 rounded-sm bg-ink/80 px-2 py-1 text-[10px] uppercase tracking-widest2 text-crimson">
      ...
      <div className="mt-3 flex items-center justify-between text-xs">
        ...
        <span className="text-scarlet">${persona.licenses.shared.price} shared</span>
      </div>
    </button>
  );
}
